...
if __name__ == "__main__":
    ...
    # Export Diffusion separately (requires the use of MoeSS/MoeVoiceStudio or writing your own Pndm/Dpm sampler)
    model.OnnxExport(project_name, export_encoder=True, export_denoise=True, export_pred=True, export_after=True)

    # Merge Diffusion export (separate Encoder and Diffusion, directly input the results of the Encoder and initial noise into Diffusion)
